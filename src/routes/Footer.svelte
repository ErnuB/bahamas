...
<footer class="fixed bottom-0 left-0 transition-all duration-300 w-full py-2 bg-white flex flex-col items-center shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]" class:show={showFooter} class:hide={!showFooter}>
    <div class="flex items-center justify-around gap-5 px-5">
        <a href="https://maps.app.goo.gl/yXXpExdsLiGichGg6" class="flex px-2 max-w-[75%] items-center" target="_blank"><i class="fa fa-location-dot text-3xl text-red-600"></i><p class="text-center text-pretty">&thinsp; Blvd. Mario López Valdez, 80058 Culiacán</p></a>
        <a href="https://www.facebook.com/profile.php?id=61561536253104" target="_top"><i class="text-3xl text-blue-800 fa-brands fa-facebook"></i></a>
        ...
        <a href="https://www.instagram.com/bahamas.mx/" target="_blank"><i class="text-4xl fa-brands fa-square fa-instagram bg-gradient-to-bl from-pink-500 via-red-500 to-yellow-500 text-transparent bg-clip-text"></i></a>
        <a href="tel:+526679419082"><i class="text-3xl fa fa-phone"></i></a>
    </div>
    <!-- <div class="w-4/5">
